...
从上图可以看出新版生命周期函数中新增“getDerivedStateFromProps”，“getSnapshotBeforeUpdate”这两个生命周期函数，去除了“componentWillReceiveProps”，“componentWillUpdate”，“componentWillMount”

### 新的是生命周期函数的意义（为何替换旧版的生命周期）？
